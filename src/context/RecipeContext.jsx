...
// Tarjima funksiyasi (faqat kerak bo‘lganda ishlaydi)
...
export const RecipeProvider = ({ children }) => {
  const [recipes] = useState(recipesData); // API dan emas, JSON dan
  ...
  // Favorites va tarjima keshlarini localStorage dan yuklash
  useEffect(() => {
  ...
  const openRecipeModal = useCallback(async (recipe) => {
    ...
    try {
      ...
      console.error(err);
      setSelectedRecipe(recipe); // tarjima xatosida aslini ko‘rsatish
    }
  }, [translatedCache]);
